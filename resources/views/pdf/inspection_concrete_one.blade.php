      ...
      ">
        <table style="width: 100%; border-collapse: collapse">
            <tr>
                <td>
                    <table style="width: 100%; border-collapse: collapse">
                        <tr>
                            ...
                            <td style="padding: 2px 0px; border-bottom: 1px solid lightgray">
                ...
                <td style="padding: 0px 5px 10px 5px; text-align: center;">
                    <div>
                        <img src="https://i0.wp.com/geocal.us/wp-content/uploads/2019/05/logo-new.png" alt="logo"
                            style="max-width: 100px" />
                        <h4 style="font-size: 14px; font-weight: 600; padding-top: 4px">
                            {{ $data->office_address }}
                        </h4>
                    </div>
                </td>
        ...
        <table style="width: 100%; border-collapse: collapse">
            ...
            <tr>
                ...
                <td style="padding: 2px 6px; border: 1px solid lightgray">
                    <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->type_fracture_f
                        }}
                    </h4>
                </td>
                <td style="padding: 2px 6px; border: 1px solid lightgray">
            ...
            <tr>
                ...
                <td style="padding: 2px 6px; border: 1px solid lightgray">
                    <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->type_fracture_g
                        }}
                    </h4>
                </td>
                <td style="padding: 2px 6px; border: 1px solid lightgray">
            ...
            <tr>
                ...
                <td style="padding: 2px 6px; border: 1px solid lightgray">
                    <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->type_fracture_h
                        }}
                    </h4>
                </td>
                <td style="padding: 2px 6px; border: 1px solid lightgray">
            ...
            <tr>
                ...
                <td style="width: 40%; text-align: center;">
                    <img src="https://i0.wp.com/geocal.us/wp-content/uploads/2019/05/logo-new.png" alt="logo"
                        style="max-width: 100px" />
                    <h4 style="font-size: 13px; font-weight: 400; padding-top: 5px">
                        {{ $data->office_address }}
                    </h4>
                    <h4 style="font-size: 13px; text-align: center; padding-top: 5px;">CONCRETE TEST REPORT</h4>
                </td>
                <td style="width: 28%; text-align: left;">
                    <h4 style="font-size: 14px; font-weight: 400;">
        ...
        <div
            style="margin-top: 5px; vertical-align: top; border-top: 3px solid #000; border-right: 3px solid #000; border-bottom: 1px solid #000; border-left: 3px solid #000;">
                ...
                <tr>
                    <td style="width: 60%; vertical-align: top;" valign="top">
                        ...
                        <h4 style="font-size: 14px; font-weight: 400">
                            Plant:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;{{ $data->plant }}</h4>
                        <h4 style="font-size: 14px; font-weight: 400">Mix Identification:
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            {{ $data->mix_id }}
                        </h4>
                        <h4 style="font-size: 14px; font-weight: 400">Specified Strength (psi):
                            &nbsp;&nbsp;{{ $data->mix_design_strength }}</h4>
                    </td>
                    <td style="width: 40%;">
                        <h4 style="font-size: 14px; font-weight: 400">Technician:
                            &nbsp;&nbsp;&nbsp;&nbsp;{{ $data->technician }}</h4>
                        <h4 style="font-size: 14px; font-weight: 400">
                            &nbsp;&nbsp;&nbsp;&nbsp;</h4>
                        <h4 style="font-size: 14px; font-weight: 400">
        ...
        <div
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->avg_length_a }}
                        </h4>
                    </td>
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->area_cyl_a }}
                ...
                <tr>
                    ...
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->avg_length_c }}
                        </h4>
                    </td>
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->area_cyl_c }}
                ...
                <tr>
                    ...
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->avg_length_d }}
                        </h4>
                    </td>
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->area_cyl_d }}
                ...
                <tr>
                    ...
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->avg_length_e }}
                        </h4>
                    </td>
                    <td style="padding: 1px;border: 1px solid #000">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:center;">{{ $data->area_cyl_e }}
        ...
        <div
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td>
                        <h4 style="font-size: 14px; font-weight: 400; text-align:left;">3-Columnar cracking/no cones;
                        </h4>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4">
                        <h4 style="padding-top: 5px; font-size: 14px; font-weight: 400; text-align:left;">Concrete sample in accordance
                            with
                            ASTM C172 and/or AASHTO R60</h4>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <h4 style="font-size: 14px; font-weight: 400; text-align:left;">Compressive Strength determined
                            in
                            accordance with ASTM C-39 and/or AASHTO T-22</h4>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        <h4 style="padding-bottom: 5px; font-size: 14px; font-weight: 400; text-align:left;">Capping: U = Unbonded (ASTM
                            C1231);
                            B = Bonded (ASTM C617); G = Ground</h4>
                    </td>
                </tr>
        ...
        <div
            style="padding-top: 5px; padding-bottom: 10px; border-top: 1px solid #000; border-right: 3px solid #000; border-bottom: 1px solid #000; border-left: 3px solid #000;">
            <table style="width: 100%; border-collapse: collapse;">
                <caption
                    style="text-align:left; font-size: 14px; font-weight: 500; padding: 0; letter-spacing: -1px; background-color: #689A3D; border-top: 2px solid #000; border-right: 0px solid #000; border-bottom: 0px solid #000; border-left: 0px solid #000;">
                    COMMENTS</caption>
                <tr>
                    ...
                    <td style="width: 32%; padding-top: 10px; padding-bottom: 10px;"></td>
                    <td
