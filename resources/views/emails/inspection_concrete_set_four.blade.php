...
<body>
  ...
  <p>Report Of Field Inspection Of Concrete – Single Mix (Data Set 4) has been created.</p>
  <p>Please check the attachment report for your next action.</p> <br>

  @if ($id)
  <a class="button button1" href="{{ route('inspection.concrete.generate.four',['id'=>$id]) }}">Concrete Test Report</a><br>
  @endif
