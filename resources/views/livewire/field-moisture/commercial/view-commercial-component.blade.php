                ...
                <div class="card">
                    <div class="row mb-5 mt-3">
                        <div class="col-md-12" style="text-align: right;">
                            <a href="{{ route('invoice.commercial',['id'=>$file_id]) }}" target="_blank" class="btn btn-primary submit_btn" style="background: green;">Download PDF</a>

                            <a href="{{ route('template.commercial') }}" class="btn btn-primary submit_btn" style="background: green;">Back To Files</a>
                        </div>
                    </div>
                </div>
            </div>
