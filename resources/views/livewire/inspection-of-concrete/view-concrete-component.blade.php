                        ...
                        <div class="row mb-3 offset-1">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text" class="form-control" wire:model="air_min">
                                    <span class="input-group-text">Max:</span>
                                    <input type="text" class="form-control" wire:model="air_max">
                                </div>
                                @error('air_content')
                                <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <span class="input-group-text">Min:</span>
                                    <input type="text" class="form-control" wire:model="slump_min">
                                    <span class="input-group-text">Max:</span>
                                    <input type="text" class="form-control" wire:model="slump_max">
                                </div>
                                @error('slump')
                                <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <span class="input-group-text">Min:</span>
                                    <input type="text" class="form-control" wire:model="concrete_temp_min">
                                    
                                    <span class="input-group-text">Max:</span>
                                    <input type="text" class="form-control" wire:model="concrete_temp_max">
                                </div>
                                @error('concrete_temp')
                                <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control moistureremoveinput"
                                                            wire:model="diameter_a.{{ $concrete_data }}">
                                                        @error('diameter_a')
                                                        <span class="text-danger" style="font-size: 12px;">{{ $message
                                                            }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number" step="any"
                                                            class="form-control moistureremoveinput"
                                                            wire:model="max_load.{{ $concrete_data }}">
                                                        @error('max_load')
                                                        <span class="text-danger" style="font-size: 12px;">{{ $message
                                                            }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control moistureremoveinput"
                                                            wire:model="area_cyl.{{ $concrete_data }}">
                                                        @error('area_cyl')
                                                        <span class="text-danger" style="font-size: 12px;">{{ $message
                                                            }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control moistureremoveinput"
                                                            wire:model="measured_strength.{{ $concrete_data }}">
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control moistureremoveinput"
                                                            wire:model="specified_strength.{{ $concrete_data }}">
