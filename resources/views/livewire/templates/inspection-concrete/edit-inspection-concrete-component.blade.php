                            ...
                            <div class="row mb-3 justify-content-md-center">
                                ...
                                <div class="col-lg-6 select-border">
                                    ...
                                    <div class="input-group mt-3">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="required_strength" wire:keyup='specifiedStrengthA'
                                            wire:keyup='specifiedStrengthB' wire:keyup='specifiedStrengthC'
                                            wire:keyup='specifiedStrengthD' wire:keyup='specifiedStrengthE'
                                            wire:keyup='specifiedStrengthF' wire:keyup='specifiedStrengthG'
                                            wire:keyup='specifiedStrengthH' wire:keyup='specifiedStrengthI'
                                            wire:keyup='specifiedStrengthJ' required>
                                    </div>
                            ...
                            <div class="row mb-3 justify-content-md-center">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-3">
                                        ...
                                        <span class="input-group-text width20">Est. RH %:</span>
                        ...
                        <div class="container">
                            <div class="row mb-3 justify-content-md-center">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Pick up by:</span>
                                        <input type="text" class="form-control form-color"
