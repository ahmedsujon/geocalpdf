                            ...
                            <div class="row">
                                <div class="col-lg-6 select-border">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="time" class="form-control form-color"
                                            wire:model="ttf_unloading" readonly>
                                    </div>
                                    @error('ttf_unloading')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="ambient_temp" readonly>
                                    </div>
                                    @error('ambient_temp')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="water_added" readonly>
                                    </div>
                                    @error('water_added')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-lg-6 select-border">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model='cylinder_id' readonly>
                                    </div>
                                    @error('cylinder_id')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="relative_yield" readonly>
                                    </div>
                                    @error('yield')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="required_strength" readonly wire:keyup='specifiedStrength'
                                            required>
                                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-color"
                                            wire:model="informed_by" readonly>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="fine_aggregate" readonly>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_a" readonly>
                                        <span class="input-group-text"></span>
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_a_a" readonly>
                                        @error('admixture_a')
                                            <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_b" readonly>
                                        <span class="input-group-text"></span>
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_b_b" readonly>
                                        @error('admixture_b')
                                            <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_c" readonly>
                                        <span class="input-group-text"></span>
                                        <input type="text" class="form-control form-color"
                                            wire:model="admixture_c_c" readonly>
                                        @error('admixture_c')
                                            <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number" step="any"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="diameter_a" wire:keyup='AreaCylA' readonly>
                                                        @error('diameter_a')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number" step="any"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="diameter_a_a" wire:keyup='AreaCylA' readonly>
                                                        @error('diameter_a_a')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number" step="any"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="max_load_a" wire:keyup='measuredStrengthA' readonly>
                                                        @error('max_load_a')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_a" required readonly>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_b" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_c" disabled readonly>
                                                        @error('test_date_c')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_c" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_d" disabled readonly>
                                                        @error('test_date_d')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_d" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_e" disabled readonly>
                                                        @error('test_date_e')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_e" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_f" disabled readonly>
                                                        @error('test_date_f')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_f" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_g" disabled readonly>
                                                        @error('test_date_g')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_g" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_h" disabled readonly>
                                                        @error('test_date_h')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_h" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="test_date_i" disabled readonly>
                                                        @error('test_date_i')
                                                            <span class="text-danger"
                                                                style="font-size: 12px;">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <select class="form-select moistureremoveinput"
                                                            wire:model="type_cap_i" required readonly>
                                                            <option value="">Select</option>
                                                            <option value="Unbonded">Unbonded</option>
                                                            <option value="Gypsum cement">Gypsum cement</option>
                                                            <option value="Neat Cement">Neat Cement</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group mt-3">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="caliper_id" readonly>
                                    </div>
                                    @error('caliper_id')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="pick_up_by" readonly>
                                        @error('pick_up_by')
                                            <span class="text-danger"
                                                style="font-size: 12px;">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="test_hours" readonly>
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="pick_up_hours" readonly>
                                        <span class="input-group-text">hour(s)</span>
                                        @error('pick_up_hours')
                                            <span class="text-danger"
                                                style="font-size: 12px;">{{ $message }}</span>
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input type="text" class="form-control form-color"
                                            wire:model="delayed_hours" readonly>
                            ...
                            <div class="container">
                                <div class="row mt-3 mb-5 justify-content-md-center">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('template.concrete') }}"
                                            class="btn btn-primary submit_btn">Back To list</a>
                                        <a href="{{ route('inspection.concrete.generate.one', ['id' => $file_id]) }}"
