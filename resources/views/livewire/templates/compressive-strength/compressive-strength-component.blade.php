                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Compressive Strength - Local Agency</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Compressive Strength - Local Agency</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a style="float: right" href="{{ route('compressive.strength.create') }}"
