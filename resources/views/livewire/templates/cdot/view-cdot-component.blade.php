                            ...
                            <div class="row mb-3 select-border justify-content-md-center">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-color" readonly
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control form-color" readonly
                                            wire:model="date">
                                    </div>
                                    @error('date')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control form-color"
                                            wire:model="density_std_count" readonly>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control form-color" readonly
                                                    ...
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="number" step="any"
                                                                ...
                                                                wire:keyup='calculateAA' readonly>
                                                        </div>
                                                    </td>
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="number" step="any"
                                                                ...
                                                                wire:keyup='calculateBB' readonly>
                                                        </div>
                                                    </td>
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="number" step="any"
                                                                ...
                                                                wire:keyup='calculateCC' readonly>
                                                        </div>
                                                    </td>
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="number" step="any"
                                                                ...
                                                                wire:keyup='calculateDD' readonly>
                                                        </div>
                                                    </td>
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="number" step="any"
                                                                ...
                                                                wire:keyup='calculateEE' readonly>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="moistureremove">
                                                        <div class="input-group">
                                                            <input type="text"
                                                                class="form-control text-center moistureremoveinput"
