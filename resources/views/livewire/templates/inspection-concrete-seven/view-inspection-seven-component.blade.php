                            ...
                            <div class="container">
                                <div class="row mt-3 mb-5 justify-content-md-center">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('template.concrete.seven') }}" class="btn btn-primary submit_btn">Back To list</a>
                                        <a href="{{ route('inspection.concrete.generate.seven',['id'=>$file_id]) }}" target="_blank"
    ...
    $(document).ready(function() {
            $('.dependent').change(function() {
                if ($(this).val() != '') {
                    ...
                    var value = $(this).val();
                    $.ajax({
                        url: "{{ route('edit_inspection_seven_representative') }}",
                        method: "POST",
                        data: {
                            file_id: file_id,
                            value: value,
