            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">REPORT OF FIELD INSPECTION OF CONCRETE – SINGLE MIX (DATA SET 7)</h4>
                        <a style="float: right" href="{{ route('concrete.create.seven') }}"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a target="_blank" href="{{ route('inspection.concrete.generate.seven',['id'=>$file->id]) }}"
                                                type="button"
                                                class="btn btn-outline-primary btn-icon-circle btn-icon-circle-sm"><i
                                                    class="ti ti-file-invoice"></i></a>
                                            <a href="{{ route('concrete.show.seven', ['file_id' => $file->id]) }}" type="button"
                                                class="btn btn-outline-success btn-icon-circle btn-icon-circle-sm"><i
                                                    class="ti ti-eye"></i></a>
                                            <a href="{{ route('concrete.update.seven', ['file_id' => $file->id]) }}" type="button"
