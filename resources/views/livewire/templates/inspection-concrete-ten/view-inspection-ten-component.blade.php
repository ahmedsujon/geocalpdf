                                            ...
                                            <tr>
                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number" step="any"
                                                            class="form-control form-color moistureremoveinput"
                                                            wire:model="max_load_a" readonly wire:keyup='measuredStrengthA' readonly>
                                                        @error('max_load_a')
                                                        <span class="text-danger" style="font-size: 12px;">{{ $message
                                                            }}</span>
                                                        @enderror
                            ...
                            <div class="container">
                                <div class="row mt-3 mb-5 justify-content-md-center">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('template.concrete.ten') }}" class="btn btn-primary submit_btn">Back To list</a>
                                        <a href="{{ route('inspection.concrete.generate.ten',['id'=>$file_id]) }}" target="_blank"
