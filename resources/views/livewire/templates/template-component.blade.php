<div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-9 pt-5 pb-5">
                            ...
                            <ul class="mt-3 mb-0">
                                <li class="mb-3"><a href="{{ route('commercial.create') }}" type="button"
    ...
    <div class="modal fade" id="InpectionConcrete" tabindex="-1" role="dialog" aria-labelledby="InpectionConcreteLabel"
        aria-hidden="true">
