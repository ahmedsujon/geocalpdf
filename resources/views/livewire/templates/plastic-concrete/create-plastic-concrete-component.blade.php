                    ...
                    <div class="card-body commercial-form">
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width28">Total Yard of Placement:</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width28">Water/Cement Ratio:</span>
                                        <input type="text" class="form-control form-color"
                                ...
                                <div class="col-lg-6 select-border">
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width15">Date:</span>
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width15">Supplier:</span>
                                        <input type="text" class="form-control form-color" wire:model="supplier">
                                        @error('supplier')
                                            <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                        @enderror
                                        <span class="input-group-text width15">Plant:</span>
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width15">Sampled By:</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Air Content (%): &nbsp; &nbsp; &nbsp;
                                            &nbsp;</span>
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Slump (in): &nbsp; &nbsp; &nbsp; &nbsp;
                                            &nbsp;
                                            &nbsp;
                                            &nbsp; &nbsp;</span>
                                        <input type="number" step="any" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Concrete Temp (°F):</span>
                                        <input type="number" step="any" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Unit Weight (pcf):</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width20">Yield: (CY):</span>
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width15">Water (lb):</span>
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width25">Admixture 1: Type / (oz)</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width25">Admixture 2: Type / (oz)</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width25">Admixture 3: Type / (oz)</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width25">Total Batch Weight (lb):</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <table class="table table-bordered moisture" style="margin-bottom: 0;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="customcolor" scope="col">Measured Strength,(psi)
                                                </th>
                                                <th class="customcolor" scope="col">Specified 28-day
                                                    Strength,(psi)
                                                </th>
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width30">Cylinders cast in:</span>
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width30">Time cylinders molded:</span>
                                        <input type="time" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width30">Where cylinders cured:</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width30">Field placement observations:</span>
                                        <input type="text" class="form-control form-color"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width22">Pick up by:</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <span class="input-group-text width22">Cylinders condition:</span>
                                        <input type="text" class="form-control form-color"
                                    ...
                                    <div class="input-group mt-3">
                                        <label class="input-group-text width22">Chargeable Time:</label>
                                    </div>
                                    @error('troxler')
                                        <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                    @enderror
