                                                ...
                                                <td class="moistureremove">
                                                    <div class="input-group">
                                                        <input type="number"
                                                            ...
                                                            wire:model="age_a" readonly
                                                            wire:keyup='specifiedStrengthA' required>
                                                        @error('age_a')
                            ...
                            <div class="container">
                                <div class="row mt-3 mb-5 justify-content-md-center">
                                    <div class="col-md-12 text-center">
                                        <a href="{{ route('template.concrete.eight') }}"
                                            class="btn btn-primary submit_btn">Back To list</a>
                                        <a href="{{ route('inspection.concrete.generate.eight', ['id' => $file_id]) }}"
        ...
        $(document).ready(function() {
            $('.dependent').change(function() {
                if ($(this).val() != '') {
                    ...
                    var value = $(this).val();
                    $.ajax({
                        url: "{{ route('edit_data_set_eight_representative') }}",
                        method: "POST",
                        data: {
                            file_id: file_id,
                            value: value,
