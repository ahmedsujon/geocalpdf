                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">CREATE INSPECTION OF CONCRETE</li>
                        </ol>
                    </div>
                    <h4 class="page-title">CREATE INSPECTION OF CONCRETE – SINGLE MIX</h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="content text-center pt-2 pb-2">
                                    <h5 style="font-weight: 700;">REPORT OF FIELD INSPECTION OF CONCRETE – SINGLE MIX (DATA SET 3)
                                    </h5>
                                </div>
                            </div>
                            <div class="col-md-3"></div>
    ...
    <script>
        $(document).ready(function() {
            $('#selectInfo').change(function() {
                ...
                $.ajax({
                    url: "{{ route('get_data_set_three_representative') }}",
                    method: "POST",
                    data: {
