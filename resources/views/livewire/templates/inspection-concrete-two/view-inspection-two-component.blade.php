                ...
                <div class="page-title-box">
                    <div class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">VIEW INSPECTION OF CONCRETE</li>
                        </ol>
                    </div>
                    <h4 class="page-title">VIEW INSPECTION OF CONCRETE – SINGLE MIX</h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="content text-center pt-2 pb-2">
                                    <h6>REPORT OF FIELD INSPECTION OF CONCRETE – SINGLE MIX (DATA SET 2)</h6>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="content text-center pt-2 pb-2">
                        ...
                        <div class="row mb-3 offset-1">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text" class="form-control form-color" required>
                                </div>
            ...
            <div class="card">
                <div class="row mb-5 mt-3">
                    <div class="col-md-12" style="text-align: center;">
                        <a href="{{ route('inspection.concrete.generate.two',['id'=>$file_id]) }}" target="_blank" class="btn btn-primary submit_btn" style="background: green;">Download Report</a>
                        <a href="{{ route('template.concrete.two') }}" class="btn btn-primary submit_btn" style="background: green;">Back To list</a>
                    </div>
                </div>
            </div>
        </div>
