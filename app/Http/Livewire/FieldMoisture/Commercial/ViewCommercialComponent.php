...
{
    public $file_title, $observation, $status, $office_address, $project_id, $user_id = [], $remark, $created_by, $pdf_details, $field_density_commercial_id, $i = 1, $j = 1;
    ...
    public function render()
    {
        ...
        return view('livewire.field-moisture.commercial.view-commercial-component', ['projects'=>$projects, 'supervisors'=>$supervisors, 'proctors'=>$proctors])->layout('livewire.layouts.base');
    }
}
