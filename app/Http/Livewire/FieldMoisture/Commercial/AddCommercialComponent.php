...
class AddCommercialComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.field-moisture.commercial.add-commercial-component', ['projects' => $projects, 'supervisors' => $supervisors, 'proctors' => $proctors])->layout('livewire.layouts.base');
    }
}
