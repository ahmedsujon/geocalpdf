...
class ViewInspectionSevenComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-seven.view-inspection-seven-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
