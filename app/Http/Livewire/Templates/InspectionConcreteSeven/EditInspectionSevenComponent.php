...
class EditInspectionSevenComponent extends Component
{
    ...
    {
        $file = InspectionConcreteSetSeven::where('id', $file_id)->first();
        ...
        if ($this->responsible_person) {
            ...
            dispatch(function () use ($persons, $f_id, $project_id, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    $select_project = InspectionConcreteSetSeven::find($f_id);
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-seven.edit-inspection-seven-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
