...
namespace App\Http\Livewire\Templates\InspectionConcreteSeven;
...
class CreateInspectionSevenComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        $data = new InspectionConcreteSetSeven();
        ...
        if ($this->responsible_person) {
            ...
            $project_id = InspectionConcreteSetSeven::find($f_id)->project_id;
            dispatch(function () use ($persons, $f_id, $project_id, $permissions, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    Mail::send('emails.inspection_concrete_set_seven', $mailData, function ($message) use ($mailData) {
        ...
        return redirect()->route('template.concrete.seven');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-seven.create-inspection-seven-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
