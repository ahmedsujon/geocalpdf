...
class ViewInspectionThreeComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-three.view-inspection-three-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
