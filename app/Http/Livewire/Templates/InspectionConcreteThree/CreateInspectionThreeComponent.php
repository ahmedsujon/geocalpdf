...
class CreateInspectionThreeComponent extends Component
{
        ...
        if ($this->responsible_person) {
            ...
            dispatch(function () use ($persons, $f_id, $project_id, $permissions, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    Mail::send('emails.inspection_concrete_set_three', $mailData, function ($message) use ($mailData) {
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-three.create-inspection-three-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
