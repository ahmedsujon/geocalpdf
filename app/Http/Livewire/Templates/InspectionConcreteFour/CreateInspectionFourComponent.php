...
class CreateInspectionFourComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        return redirect()->route('template.concrete.four');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-four.create-inspection-four-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
