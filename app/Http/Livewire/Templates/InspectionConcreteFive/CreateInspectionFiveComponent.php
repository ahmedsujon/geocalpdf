...
namespace App\Http\Livewire\Templates\InspectionConcreteFive;
...
class CreateInspectionFiveComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        if ($this->responsible_person) {
            ...
            $project_id = InspectionConcreteSetFive::find($f_id)->project_id;
            dispatch(function () use ($persons, $f_id, $project_id, $permissions, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    Mail::send('emails.inspection_concrete_set_five', $mailData, function ($message) use ($mailData) {
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-five.create-inspection-five-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
