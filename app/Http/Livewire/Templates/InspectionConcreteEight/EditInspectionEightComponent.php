...
class EditInspectionEightComponent extends Component
{
    ...
    {
        $file = InspectionConcreteSetEight::where('id', $file_id)->first();
        ...
        if ($this->responsible_person) {
            ...
            dispatch(function () use ($persons, $f_id, $project_id, $permissions, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    $select_project = InspectionConcreteSetEight::find($f_id);
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-eight.edit-inspection-eight-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
