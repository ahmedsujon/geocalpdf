...
class CreateInspectionEightComponent extends Component
{
    ...
    public function updateData()
    {
        ...
        if ($this->responsible_person) {
            ...
            $project_id = InspectionConcreteSetEight::find($f_id)->project_id;
        ...
        return redirect()->route('template.concrete.eight');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-eight.create-inspection-eight-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
