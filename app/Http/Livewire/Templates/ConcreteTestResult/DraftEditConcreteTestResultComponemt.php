...
class DraftEditConcreteTestResultComponemt extends Component
{
    ...
    public function updateData($publish_status)
    {
        ...
        $data = ConcreteTestResult::where('id', $this->file_id)->first();
    ...
    public function render()
    {
        ...
        return view('livewire.templates.concrete-test-result.draft-edit-concrete-test-result-componemt', ['projects' => $projects, 'supervisors' => $supervisors])->layout('livewire.layouts.base');
    }
}
