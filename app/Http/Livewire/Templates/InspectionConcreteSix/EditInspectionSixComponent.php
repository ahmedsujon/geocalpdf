...
class EditInspectionSixComponent extends Component
{
    ...
    {
        $file = InspectionConcreteSetSix::where('id', $file_id)->first();
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-six.edit-inspection-six-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
