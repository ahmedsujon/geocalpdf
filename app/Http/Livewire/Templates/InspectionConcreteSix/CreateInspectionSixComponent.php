...
class CreateInspectionSixComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        $data = new InspectionConcreteSetSix();
        ...
        if ($this->responsible_person) {
            ...
            $f_id = $data->id;
            $project_id = InspectionSixComponent::find($f_id)->project_id;
            dispatch(function () use ($persons, $f_id, $project_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    Mail::send('emails.inspection_concrete_set_six', $mailData, function ($message) use ($mailData) {
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-six.create-inspection-six-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
