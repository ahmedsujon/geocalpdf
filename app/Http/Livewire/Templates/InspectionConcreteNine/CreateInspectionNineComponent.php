...
namespace App\Http\Livewire\Templates\InspectionConcreteNine;
...
class CreateInspectionNineComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        $data = new InspectionConcreteSetNine();
        ...
        if ($this->responsible_person) {
            ...
            dispatch(function () use ($persons, $f_id, $project_id, $permissions) {
                foreach ($persons as $key => $re_id) {
                    ...
                    Mail::send('emails.inspection_concrete_set_nine', $mailData, function ($message) use ($mailData) {
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-nine.create-inspection-nine-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
