...
class CreateInspectionTwoComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        $data = new InspectionConcreteSetTwo();
        ...
        return redirect()->route('template.concrete.two');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-two.create-inspection-two-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
