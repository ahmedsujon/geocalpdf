...
class EditInspectionTwoComponent extends Component
{
    ...
    {
        $file = InspectionConcreteSetTwo::where('id', $file_id)->first();
        ...
        if ($this->responsible_person) {
            ...
            dispatch(function () use ($persons, $f_id, $project_id, $permissions, $auth_user_id) {
                foreach ($persons as $key => $re_id) {
                    ...
                    $select_project = InspectionConcreteSetTwo::find($f_id);
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-two.edit-inspection-two-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
