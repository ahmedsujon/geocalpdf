...
class CreateInspectionTenComponent extends Component
{
    ...
    public function storeData()
    {
        ...
        if ($this->responsible_person) {
            ...
            $f_id = $data->id;
            $project_id = InspectionTenComponent::find($f_id)->project_id;
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-ten.create-inspection-ten-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
