...
class ViewInspectionTenComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.templates.inspection-concrete-ten.view-inspection-ten-component', ['projects' => $projects])->layout('livewire.layouts.base');
    }
}
