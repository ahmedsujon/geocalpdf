...
class CreateInspectionConcretesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_concretes', function (Blueprint $table) {
            $table->id();
            // Project Information
    ...
    {
        Schema::dropIfExists('inspection_concretes');
    }
}
