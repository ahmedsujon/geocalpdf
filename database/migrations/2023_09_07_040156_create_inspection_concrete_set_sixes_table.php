...
class CreateInspectionConcreteSetSixesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_concrete_set_sixes', function (Blueprint $table) {
            $table->id();
            // Project Information
    ...
    {
        Schema::dropIfExists('inspection_concrete_set_sixes');
    }
}
