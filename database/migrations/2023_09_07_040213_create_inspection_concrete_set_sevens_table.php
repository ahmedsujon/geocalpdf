...
class CreateInspectionConcreteSetSevensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_concrete_set_sevens', function (Blueprint $table) {
            $table->id();
            // project information
    ...
    {
        Schema::dropIfExists('inspection_concrete_set_sevens');
    }
}
