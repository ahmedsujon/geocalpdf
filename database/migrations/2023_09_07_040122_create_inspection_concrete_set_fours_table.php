...
class CreateInspectionConcreteSetFoursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inspection_concrete_set_fours', function (Blueprint $table) {
            $table->id();
            // Project Information
    ...
    {
        Schema::dropIfExists('inspection_concrete_set_fours');
    }
}
